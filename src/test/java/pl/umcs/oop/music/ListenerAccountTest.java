...
class ListenerAccountTest {
    ...
    public void testCreatePlaylist() throws NotEnoughCreditsException {
        ...
        manuallyPlaylist.add(song1); manuallyPlaylist.add(song2);
        manuallyPlaylist.add(song3); manuallyPlaylist.add(song4);
        ...
        listIdSongs.add(39);  listIdSongs.add(10);
        listIdSongs.add(24);  listIdSongs.add(8);
